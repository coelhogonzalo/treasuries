...
class TreasurySerializer(serializers.ModelSerializer):
    ...
    filingurl = serializers.URLField(required=False, allow_null=True, allow_blank=True, max_length=2048)
    ...
    info_url = serializers.CharField(required=False, allow_null=True, allow_blank=True, max_length=2048)
